...
package Levels
{
	...
	// Custom imports:
import entities.*
	public class Level_Endurance extends mapBase
	{
		//Embedded media...
		[Embed(source="../maps/mapCSV_Group1_Endurance.csv", mimeType="application/octet-stream")] public var CSV_Group1Endurance:Class;
		[Embed(source="../../../../../../../../My Documents/My Dropbox/Private/FlashDevelop/Projects/FlixelVania/src/data/tiles/DebugTiles.png")] public var Img_Group1Endurance:Class;

		//Tilemaps
		public var layerGroup1Endurance:FlxTilemap;

		//Sprites
		public var Group2Layer1Group:FlxGroup = new FlxGroup;


		public function Level_Endurance(addToStage:Boolean = true, onAddSpritesCallback:Function = null)
		{
			// Generate maps.
			layerGroup1Endurance = new FlxTilemap;
			layerGroup1Endurance.loadMap( new CSV_Group1Endurance, Img_Group1Endurance, 16,16, FlxTilemap.OFF, 0, 1, 1 );
			layerGroup1Endurance.x = 0.000000;
			layerGroup1Endurance.y = 0.000000;
			layerGroup1Endurance.scrollFactor.x = 1.000000;
			layerGroup1Endurance.scrollFactor.y = 1.000000;

			//Add layers to the master group in correct order.
			masterLayer.add(layerGroup1Endurance);
			...
			mainLayer = layerGroup1Endurance;
