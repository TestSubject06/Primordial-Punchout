package
{
	...
	public class WinState2 extends FlxState
	{
		...
		private var numm:int = 0;
		public function WinState2(num:int) {
			numm = num;
		}
		override public function create():void
		{
			...
			Title = new FlxText(0, FlxG.height / 3, FlxG.width, "You've finally been defeated!")
			Title.alignment = "center";
			add(Title);
			
			Title2 = new FlxText(0, FlxG.height / 3 + 20, FlxG.width, "You murdered " + numm.toString() + " slimes!")
			Title2.alignment = "center";
			add(Title2)
			
			Title3 = new FlxText(0, FlxG.height / 3 + 40, FlxG.width, "Did you check out the turret at the bottom?")
			Title3.alignment = "center";
			add(Title3);
			
			Title4 = new FlxText(0, FlxG.height / 3 + 70, FlxG.width, "You can control it with QWE.")
